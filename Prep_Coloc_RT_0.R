##Preparing Regenie output  *Reaction time	(Mean time to correctly identify matches.0.0) 
...
#Adding MAF
DB1 <- read.table("ReactionTime_0/ukb_step2_RT_0.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='ReactionTime_0/ukb_step2_RT_0_add.rds')
#Tab delimited text file
write.table(DB, file = "ReactionTime_0/ukb_step2_RT_0_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("ReactionTime_0/ukb_step2_RT_0_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 