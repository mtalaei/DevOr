##Preparing Regenie output  *Numeric memory (Maximum digits remembered correctly.2.0) 
...
#Adding MAF
DB1 <- read.table("NumericMemory_0/ukb_step2_NM_0.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='NumericMemory_0/ukb_step2_NM_0_add.rds')
#Tab delimited text file
write.table(DB, file = "NumericMemory_0/ukb_step2_NM_0_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("NumericMemory_0/ukb_step2_NM_0_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 