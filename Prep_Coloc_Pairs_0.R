##Preparing Regenie output  *Pairs matching	(Number of incorrect matches in round.0.0) 
...
#Adding MAF
DB1 <- read.table("PairsMatching_0/ukb_step2_Pairs_0.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='PairsMatching_0/ukb_step2_Pairs_0_add.rds')
#Tab delimited text file
write.table(DB, file = "PairsMatching_0/ukb_step2_Pairs_0_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("PairsMatching_0/ukb_step2_Pairs_0_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 