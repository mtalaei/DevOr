...
#Adding MAF
DB1 <- read.table("gF4_0/ukb_step2_gF4_0.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='gF4_0/ukb_step2_gF4_0_add.rds')
#Tab delimited text file
write.table(DB, file = "gF4_0/ukb_step2_gF4_0_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("gF4_0/ukb_step2_gF4_0_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 