...
#Adding MAF
DB1 <- read.table("FluidIntelligence_0/ukb_step2_FI_0.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='FluidIntelligence_0/ukb_step2_FI_0_add.rds')
#Tab delimited text file
write.table(DB, file = "FluidIntelligence_0/ukb_step2_FI_0_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("FluidIntelligence_0/ukb_step2_FI_0_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 