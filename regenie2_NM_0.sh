##Regenie-2  Numeric memory (Maximum digits remembered correctly.0.0 --> R_Test5_NumericMemory_f4282_0)
...
odir="/data/home/hmy431/outputs/NumericMemory_0"         #Output directory
...
./regenie_v2.2.4.gz_x86_64_Centos7_mkl  \
  ...
  --phenoFile ${ddir}/NumericMemory_0.txt \
  --phenoColList NumericMemory_0_z \
  ...
  --pred ${odir}/ukb_step1_NM_0_pred.list \
  --bsize 1000 \
  --threads 8 \
  --strict \
  --minMAC 10 \
...
cp ${odir}/ukb_step2_chr1_NumericMemory_0_z.regenie ${odir}/ukb_step2_NM_0.regenie
for i in {2..22}; do
cp ${odir}/ukb_step2_chr${i}_NumericMemory_0_z.regenie ${odir}/ukb_step2_chr${i}
sed -i '1d' ${odir}/ukb_step2_chr${i}
cat ${odir}/ukb_step2_chr${i} >> ${odir}/ukb_step2_NM_0.regenie
