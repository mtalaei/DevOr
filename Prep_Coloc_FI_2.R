##Preparing Regenie output  *Fluid intelligence/reasoning (Fluid intelligence score.2.0) 
...
#Adding MAF
DB1 <- read.table("FluidIntelligence_2/ukb_step2_FI_2.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='FluidIntelligence_2/ukb_step2_FI_2_add.rds')
#Tab delimited text file
write.table(DB, file = "FluidIntelligence_2/ukb_step2_FI_2_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("FluidIntelligence_2/ukb_step2_FI_2_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 