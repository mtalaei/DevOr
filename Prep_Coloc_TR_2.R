##Tower rearranging  *Number of puzzles correct.2.0) 
...
#Adding MAF
DB1 <- read.table("TowerRearranging_2/ukb_step2_TR_2.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='TowerRearranging_2/ukb_step2_TR_2_add.rds')
#Tab delimited text file
write.table(DB, file = "TowerRearranging_2/ukb_step2_TR_2_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("TowerRearranging_2/ukb_step2_TR_2_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 