##Preparing Regenie output  *Matrix pattern completion	[Number of puzzles correctly solved.2.0 (corrected for views, ratio)] 
...
#Adding MAF
DB1 <- read.table("MatrixPattern_2/ukb_step2_MP_2.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='MatrixPattern_2/ukb_step2_MP_2_add.rds')
#Tab delimited text file
write.table(DB, file = "MatrixPattern_2/ukb_step2_MP_2_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("MatrixPattern_2/ukb_step2_MP_2_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 