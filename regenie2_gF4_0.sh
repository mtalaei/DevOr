##Regenie-2   g-Factor 4 components    @Baseline
...
./regenie_v2.2.4.gz_x86_64_Centos7_mkl  \
  ...
  --pred ${odir}/ukb_step1_gF4_0_pred.list \
  --bsize 1000 \
  --threads 8 \
  --strict \
  --minMAC 10 \
...
cp ${odir}/ukb_step2_chr1_gF4_0.regenie ${odir}/ukb_step2_gF4_0.regenie
for i in {2..22}; do
cp ${odir}/ukb_step2_chr${i}_gF4_0.regenie ${odir}/ukb_step2_chr${i}
sed -i '1d' ${odir}/ukb_step2_chr${i}
cat ${odir}/ukb_step2_chr${i} >> ${odir}/ukb_step2_gF4_0.regenie
