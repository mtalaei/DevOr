##Regenie-1  Paired associate learning	(Number of word pairs correctly associated.2.0)
...
odir="/data/home/hmy431/outputs/PairedLearning_2"     #Output directory
...
./regenie_v2.2.4.gz_x86_64_Centos7_mkl  \
  ...
  --phenoFile ${ddir}/PairedLearning_2.txt \
  --phenoColList PairedLearning_2_z \
