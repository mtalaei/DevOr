##Preparing Regenie output  *Dementia	(All types) 
...
#Adding MAF
DB1 <- read.table("Dementia/ukb_step2_Dem.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='Dementia/ukb_step2_Dem_add.rds')
#Tab delimited text file
write.table(DB, file = "Dementia/ukb_step2_Dem_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("Dementia/ukb_step2_Dem_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 