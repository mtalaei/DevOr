##Preparing Regenie output  *Paired associate learning	(Number of word pairs correctly associated.2.0) 
...
#Adding MAF
DB1 <- read.table("PairedLearning_2/ukb_step2_PAL_2.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='PairedLearning_2/ukb_step2_PAL_2_add.rds')
#Tab delimited text file
write.table(DB, file = "PairedLearning_2/ukb_step2_PAL_2_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("PairedLearning_2/ukb_step2_PAL_2_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 