##Regenie-2  g-Factor 5 components    @Instance-2      Imputed    Executive Function score
...
odir="/data/home/hmy431/outputs/gF5i_2"                 #Output directory
...
./regenie_v2.2.4.gz_x86_64_Centos7_mkl  \
  ...
  --pred ${odir}/ukb_step1_gF5i_2_pred.list \
  --bsize 1000 \
  --threads 8 \
  --strict \
  --minMAC 10 \
...
cp ${odir}/ukb_step2_chr1_gF5i_2.regenie ${odir}/ukb_step2_gF5i_2.regenie
for i in {2..22}; do
cp ${odir}/ukb_step2_chr${i}_gF5i_2.regenie ${odir}/ukb_step2_chr${i}
sed -i '1d' ${odir}/ukb_step2_chr${i}
cat ${odir}/ukb_step2_chr${i} >> ${odir}/ukb_step2_gF5i_2.regenie
