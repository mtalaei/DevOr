##Regenie-1  Reaction time	(Mean time to correctly identify matches.0.0 --> R_Test2_ReactionTime_f20023_0)
...
odir="/data/home/hmy431/outputs/ReactionTime_0"   #Output directory
...
./regenie_v2.2.4.gz_x86_64_Centos7_mkl \
  ...
  --phenoFile ${ddir}/ReactionTime_0.txt \
  --phenoColList ReactionTime_0_logrz \
