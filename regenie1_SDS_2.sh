##Regenie-1  Symbol digit substitution	(Number of symbol digit matches made correctly.2.0)
...
odir="/data/home/hmy431/outputs/SymbolDigit_2"      #Output directory
...
./regenie_v2.2.4.gz_x86_64_Centos7_mkl  \
  ...
  --phenoFile ${ddir}/SymbolDigit_2.txt \
  --phenoColList SymbolDigit_c_2_z \
