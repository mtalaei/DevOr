##Preparing Regenie output  *Pairs matching	(Number of incorrect matches in round.2.0) 
...
#Adding MAF
DB1 <- read.table("PairsMatching_2/ukb_step2_Pairs_2.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='PairsMatching_2/ukb_step2_Pairs_2_add.rds')
#Tab delimited text file
write.table(DB, file = "PairsMatching_2/ukb_step2_Pairs_2_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("PairsMatching_2/ukb_step2_Pairs_2_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 
