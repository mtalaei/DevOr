...
#Adding MAF
DB1 <- read.table("ReactionTime_2/ukb_step2_RT_2.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='ReactionTime_2/ukb_step2_RT_2_add.rds')
#Tab delimited text file
write.table(DB, file = "ReactionTime_2/ukb_step2_RT_2_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("ReactionTime_2/ukb_step2_RT_2_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 
