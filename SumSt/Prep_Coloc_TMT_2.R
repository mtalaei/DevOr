##Preparing Regenie output  *TMT B-A	[Trail making duration (alphanum-num)] 
...
#Adding MAF
DB1 <- read.table("TrailMakingANN_2/ukb_step2_TMT_2.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='TrailMakingANN_2/ukb_step2_TMT_2_add.rds')
#Tab delimited text file
write.table(DB, file = "TrailMakingANN_2/ukb_step2_TMT_2_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("TrailMakingANN_2/ukb_step2_TMT_2_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 
