...
#Adding MAF
DB1 <- read.table("NumericMemory_2/ukb_step2_NM_2.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='NumericMemory_2/ukb_step2_NM_2_add.rds')
#Tab delimited text file
write.table(DB, file = "NumericMemory_2/ukb_step2_NM_2_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("NumericMemory_2/ukb_step2_NM_2_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 
