...
#Adding MAF
DB1 <- read.table("gF5i_2/ukb_step2_gF5i_2.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='gF5i_2/ukb_step2_gF5i_2_add.rds')
#Tab delimited text file
write.table(DB, file = "gF5i_2/ukb_step2_gF5i_2_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("gF5i_2/ukb_step2_gF5i_2_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 
