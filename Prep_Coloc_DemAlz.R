##Preparing Regenie output  *Alzheimer's Disease  
...
#Adding MAF
DB1 <- read.table("DemAlz/ukb_step2_DemAlz.regenie", header=TRUE)
...
#Save
saveRDS(DB, file='DemAlz/ukb_step2_DemAlz_add.rds')
#Tab delimited text file
write.table(DB, file = "DemAlz/ukb_step2_DemAlz_add.txt", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
#Compressed file
write.table(DB, gzfile("DemAlz/ukb_step2_DemAlz_add.txt.gz"), row.names = FALSE, col.names = TRUE, quote = FALSE) 